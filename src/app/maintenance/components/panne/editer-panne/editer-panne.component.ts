...
@Component({
  selector: 'app-editer-panne',
  templateUrl: './editer-panne.component.html',
  styleUrls: ['./editer-panne.component.css']
})
export class EditerPanneComponent implements OnInit {

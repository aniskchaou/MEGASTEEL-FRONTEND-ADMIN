...
@Component({
  selector: 'app-editer-piece',
  templateUrl: './editer-piece.component.html',
  styleUrls: ['./editer-piece.component.css']
})
export class EditerPieceComponent implements OnInit {
